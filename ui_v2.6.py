...
try:
    from chamber_sim.doe import DOEManager, DOERunner, DOE_RUN_SHEETS
...
class ComsolChamberSimUI(QMainWindow):
    ...
    def _build_menu(self) -> None:
        ...
        doe_tab_action.triggered.connect(lambda: self.settings_tabs.setCurrentIndex(5))
    ...
    def _build_ribbon(self) -> QWidget:
        ...
        layout.addWidget(self._ribbon_group("Navigation", [
            ...
            ("DOE", lambda: self.settings_tabs.setCurrentIndex(5), False),
        ]))
        layout.addStretch(1)
        return ribbon
    ...
    def _start_doe_worker(self, *, dry_run: bool) -> None:
        if self._doe_running:
